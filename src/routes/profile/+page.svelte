      ...
      <div class="stats-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            ...
            <p class="stat-value">{formatPlaytimeLong(stats.totalPlaytimeMs)}</p>
          </div>
        </div>
        ...
        {#if stats.mostPlayedInstallation}
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <p class="stat-subtext">{formatPlaytime(stats.mostPlayedInstallation.total_time_played_ms)}</p>
            </div>
          </div>
        {/if}
        ...
        {#if worldStats?.largestWorld}
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <p class="stat-subtext">{formatSize(worldStats.largestWorld.size_mb)}</p>
            </div>
          </div>
        {/if}
        ...
        {#if stats.mostUsedLoader}
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <p class="stat-subtext">{stats.loaderCounts[stats.mostUsedLoader]} installations</p>
            </div>
          </div>
        {/if}
        ...
        {#if worldStats?.mostCommonGameMode}
          <div class="stat-card">
            ...
            <div class="stat-content">
              ...
              <p class="stat-subtext">{worldStats.gameModeCounts[worldStats.mostCommonGameMode]} worlds</p>
            </div>
          </div>
        {/if}
