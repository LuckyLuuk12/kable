...
export const commands = {
  ...
  getActiveAccount: () =>
    typedError<
      ...
      string
    >(__TAURI_INVOKE("get_active_account")),
  ...
  browse: (profile: KableProfile, search: ProjectSearch, smartFilter: boolean, projectType: ProjectType) =>
    typedError<ModrinthResults_Serialize, string>(__TAURI_INVOKE("browse", { profile, search, smartFilter, projectType })),
  listProfileProjects: (profile: KableProfile, enabled: boolean) =>
    typedError<Partial<{ [key in ProjectType]: KableProject_Serialize[] }>, string>(__TAURI_INVOKE("list_profile_projects", { profile, enabled })),
  removeProject: (profile: KableProfile, kableProject: KableProject_Deserialize) =>
    typedError<KableProject_Serialize, string>(__TAURI_INVOKE("remove_project", { profile, kableProject })),
  addProjectToProfile: (profile: KableProfile, project: Project_Deserialize, versionId: string | null) =>
    typedError<KableProject_Serialize, string>(__TAURI_INVOKE("add_project_to_profile", { profile, project, versionId })),
  checkForUpdate: (kableProfile: KableProfile, kableProject: KableProject_Deserialize) =>
    typedError<Project_Serialize, string>(__TAURI_INVOKE("check_for_update", { kableProfile, kableProject })),
  checkForUpdates: (profile: KableProfile, projectType: ProjectType) =>
    typedError<UpdateMap_Serialize[], string>(__TAURI_INVOKE("check_for_updates", { profile, projectType })),
  updateProject: (profile: KableProfile, kableProject: KableProject_Deserialize) =>
    typedError<KableProject_Serialize, string>(__TAURI_INVOKE("update_project", { profile, kableProject })),
  updateAllProjects: (profile: KableProfile, projectType: ProjectType) =>
    typedError<KableProject_Serialize[], string>(__TAURI_INVOKE("update_all_projects", { profile, projectType })),
  ...
  createProfile: (
    ...
    mrpack: string | null,
  ) => typedError<KableProfile, string>(__TAURI_INVOKE("create_profile", { versionId, baseProfile, exportedProfile, mrpack })),
  ...
  toggleProject: (profile: KableProfile, kableProject: KableProject_Deserialize) =>
    typedError<KableProfile, string>(__TAURI_INVOKE("toggle_project", { profile, kableProject })),
  toggleFavorite: (profile: KableProfile) => typedError<KableProfile, string>(__TAURI_INVOKE("toggle_favorite", { profile })),
  isProjectEnabled: (profile: KableProfile, kableProject: KableProject_Deserialize) =>
    typedError<boolean, string>(__TAURI_INVOKE("is_project_enabled", { profile, kableProject })),
