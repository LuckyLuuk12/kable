...
import type { CategorizedLauncherSettings, GeneralSettings, AppearanceSettings, LoggingSettings, NetworkSettings, ContentSettings, AdvancedSettings, MiscSettings, LauncherSettings, MinecraftDirectoryInfo } from '../types';
