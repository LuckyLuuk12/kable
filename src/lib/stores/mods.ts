...
import { type ModInfoKind, ProviderKind, type ModFilter, type KableInstallation, type ExtendedModInfo } from '$lib';
...
export const extendedModInfo = writable<{ [modId: string]: ExtendedModInfo | null }>({});