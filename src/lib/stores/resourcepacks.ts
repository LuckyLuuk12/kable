...
export const resourcepacksInstallation = writable<KableInstallation | null>(
  null,
);

// Installation mode: 'dedicated' or 'global'
export const resourcepacksInstallMode = writable<"dedicated" | "global">(
  "dedicated",
);
