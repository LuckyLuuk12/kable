...
-->
<script lang="ts">
import { NotificationContainer, NotificationTray, clickSound } from "$lib";
...
<div class="window">
  <div class="titlebar">
    ...
    <div class="titlebar-right">
      ...
      <button use:clickSound class="titlebar-btn minimize" title="Minimize" aria-label="Minimize" onclick={minimize}>
      ...
      <button use:clickSound class="titlebar-btn close" title="Close" aria-label="Close" onclick={close}>
        <svg width="16" height="16" viewBox="0 0 16 16">
...
.titlebar-left {
  ...
  .app-icon {
    ...
    height: 24px;
    border-radius: 6px;
    box-shadow: 0 2px 8px #{"color-mix(in srgb, $color-accent, 8%, transparent)"};
  }
