          ...
          >
            <div class="card-top-actions">
              <button
                ...
                on:click={async (e) => {
                  e.stopPropagation();
                  await InstallationService.toggleFavorite(installation);
                }}
              >
                  ...
                  >
                    ...
                    <button
                      ...
                      on:click={async () => {
                        try {
                          const path =
                            await InstallationService.createShortcut(
                              installation,
                            );
            ...
            <div class="installation-main">
              <div class="installation-icon-column">
                ...
                <button
                  ...
                  on:click={async () => {
                    await Launcher.launchInstallation(installation);
                  }}
              ...
              <div class="installation-actions">
                ...
                <button
                  ...
                  on:click={async () => {
                    try {
                      const path =
                        await InstallationService.createShortcut(installation);
                      console.log("Shortcut created at:", path);
                    } catch (err) {
                      console.error("Failed to create shortcut:", err);
                    }
...
.installation-card {
  ...
  box-shadow:
    ...
    0 0.09375rem 0.25rem rgba(80, 80, 90, 0.04); // 2px 12px, 1.5px 4px
...
.play-below-icon {
  ...
  border: none;
  border-radius: 0.7em;
  box-shadow: 0 0.125rem 0.75rem rgba(80, 80, 90, 0.1); // 2px 12px
  transition:
    background 0.15s,
    box-shadow 0.15s,
    filter 0.15s;
  ...
  &:focus {
    ...
    box-shadow:
      ...
      0 0 0 0.125rem rgba(0, 0, 0, 0.08); // 6px 32px 2px
    opacity: 1;
