...
export const availableTemplates = writable<
...
export class IconService {
  ...
  static async initialize(): Promise<void> {
    ...
    try {
      ...
      const templateName =
        settings.appearance.selected_icon_template || "emoji";
  ...
  private static setupBuiltinTemplates(): void {
    ...
    this.builtinTemplates.set("svg", {
      ...
      iconType: "svg",
      fallbackIcon:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9,9h6v6H9z"/></svg>',
      icons: {
        // Navigation & UI
        ...
        settings:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v6m0 6v6m11-7h-6m-6 0H1m15.5-7.5L19 7l-1.5 1.5m-11 11L5 17l1.5-1.5M6.5 6.5 5 7l1.5 1.5"/></svg>',
        profile:
        ...
        shaders:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12,2 22,8.5 22,15.5 12,22 2,15.5 2,8.5"/><path d="M12 8.5v7"/></svg>',
        ...
        install:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 16h2a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/><polyline points="8,12 12,16 16,12"/><line x1="12" y1="16" x2="12" y2="8"/></svg>',
        uninstall:
        ...
        launch:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h6v6"/><path d="m10 14 11-11"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>',
        ...
        "eye-off":
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.48 18.48 0 0 1 5.06-5.94"/><path d="M1 1l22 22"/><path d="M14.12 14.12a3 3 0 0 1-4.24-4.24"/></svg>',
        backup:
        ...
        loader:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>',
        authenticated:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4"/><path d="M21 12c-1 0-3-1-3-3s2-3 3-3 3 1 3 3-2 3-3 3"/><path d="M3 12c1 0 3-1 3-3s-2-3-3-3-3 1-3 3 2 3 3 3"/><path d="M3 12h6m6 0h6"/></svg>',
        ...
        unlock:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><circle cx="12" cy="16" r="1"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/></svg>',
        ...
        "folder-open":
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 14l1.45-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2"/></svg>',
        ...
        // Minecraft Specific
        minecraft:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="4" width="16" height="16" rx="2" ry="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="15" y2="1"/><line x1="9" y1="23" x2="15" y2="23"/><line x1="1" y1="9" x2="1" y2="15"/><line x1="23" y1="9" x2="23" y2="15"/></svg>',
        block:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><rect x="7" y="7" width="10" height="10"/></svg>',
        pickaxe:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 14l8-8"/><path d="M18 6l4 4"/><path d="M8 10l-4 4 6 6 4-4"/></svg>',
        sword:
        ...
        diamond:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 3h12l4 6-10 12L2 9z"/><path d="M11 3 8 9l4 12 4-12-3-6"/><path d="M2 9h20"/></svg>',
        emerald:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 3h12l4 6-10 12L2 9z"/><path d="M11 3 8 9l4 12 4-12-3-6"/><path d="M2 9h20"/></svg>',
        ...
        fabric:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7v10l10 5 10-5V7z"/><polyline points="2,7 12,12 22,7"/><polyline points="12,22 12,12"/></svg>',
        ...
        hammer:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 12l-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0-.83-.83-.83-2.17 0-3L12 9"/><path d="M17.64 15L22 10.64"/><path d="M20.05 11.38L12.67 4l-2.05 2.05 7.38 7.38z"/></svg>',
        cube: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="7.5,4.21 12,6.81 16.5,4.21"/><polyline points="7.5,19.79 7.5,14.6 3,12"/><polyline points="21,12 16.5,14.6 16.5,19.79"/><polyline points="3.27,6.96 12,12.01 20.73,6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>',
        forge:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="17" width="18" height="4" rx="1"/><rect x="7" y="13" width="10" height="4" rx="1"/><rect x="10" y="9" width="4" height="4" rx="1"/></svg>', // Anvil SVG
        neoforge:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20c0-4 4-8 8-8s8 4 8 8"/><path d="M8 20c0-2 2-4 4-4s4 2 4 4"/><path d="M12 12c-2-2-2-6 0-8 2 2 2 6 0 8z"/><path d="M12 12c2-2 2-6 0-8"/><circle cx="12" cy="16" r="1"/><circle cx="9" cy="18" r="1"/><circle cx="15" cy="18" r="1"/></svg>', // Fox SVG
        ...
        avatar:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
        crown:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 18h20l-2-12-3 7-5-7-5 7-3-7z"/><path d="M7 18v2"/><path d="M12 18v2"/><path d="M17 18v2"/></svg>',
        user: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
        "user-plus":
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>',
        "qr-code":
        ...
        paste:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/></svg>',
        ...
        layout:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>',
        ...
        compass:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polygon points="16.24,7.76 14.12,14.12 7.76,16.24 9.88,9.88"/></svg>',
        ...
        cloud:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 10h1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>',
        server:
        ...
        microsoft:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="8" height="8"/><rect x="13" y="3" width="8" height="8"/><rect x="3" y="13" width="8" height="8"/><rect x="13" y="13" width="8" height="8"/></svg>',
        ...
        timer:
          '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="M6.38 18.7 4 21"/><path d="M17.64 18.67 20 21"/></svg>',
   ...
   */
  static getIconWithFallback(
    iconName: string,
    forceType: "emoji" | "fontawesome" | "svg" | "system" | "css" | null = null,
  ): { icon: string; type: string; fallback: string } {
    ...
    if (activeTemplate) {
      const icon =
        activeTemplate.icons[iconName] || activeTemplate.fallbackIcon;
      return {
        icon,
        type: activeTemplate.iconType,
        fallback: activeTemplate.fallbackIcon,
  ...
  static async setActiveTemplate(templateName: string): Promise<void> {
    try {
      ...
      if (
        !this.builtinTemplates.has(templateName) &&
        !this.customTemplates.has(templateName)
      ) {
   ...
   */
  static async installCustomTemplate(
  ...
  static getDefaultIcon(
    name: string,
    type: "svg" | "emoji" | "fontawesome" | "system" | "css" | null = "emoji",
  ): string {
    const template =
      this.builtinTemplates.get(type as string) ||
      this.customTemplates.get(type as string);
    if (template) {
      return template.icons[name] || template.fallbackIcon;
    }
    return type === "emoji"
      ? "❓"
      : '<svg viewBox="0 0 24 24"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle">?</text></svg>';
  }
}
