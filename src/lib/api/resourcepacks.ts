...
export async function searchModrinthResourcepacks(
  ...
  return invoke("search_modrinth_resourcepacks", {
    query,
    minecraftVersion,
    limit,
    offset,
...
export async function searchModrinthResourcepacksWithFacets(
  ...
  return invoke("search_modrinth_resourcepacks_with_facets", {
    query,
    minecraftVersion,
    facets,
    limit,
...
export async function getModrinthResourcepackDetails(
  projectId: string,
): Promise<ResourcePackDownload> {
...
export async function downloadAndInstallResourcepack(
  ...
  return invoke("download_and_install_resourcepack", {
    minecraftPath,
    downloadUrl,
    filename,
  });
...
export async function setupResourcepackSymlink(
  ...
  return invoke("setup_resourcepack_symlink", {
    minecraftPath,
    dedicatedFolder,
    symlinkName,
  });
...
export async function removeResourcepackSymlink(
  minecraftPath: string,
  symlinkName: string,
): Promise<void> {
